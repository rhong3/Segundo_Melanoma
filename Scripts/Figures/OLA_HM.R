...
OLA.prot$Feature = gsub('month-', 'mo', OLA.prot$Feature)
OLA.prot$Feature = gsub('survival', '', OLA.prot$Feature)
...
write.csv(OLA.prot.table.out, "~/documents/Segundo_Melanoma/Results/Figures/Figure5-S5/OLA_HM_proteomics.csv", row.names = TRUE)

col_fun1 = colorRamp2(c(0, 0.05), c("#66A61E", "white"))
col_fun2 = colorRamp2(c(0, 10000), c("white","#253494"))
col_fun3 = colorRamp2(c(0, 4), c("white","#E31A1C"))
col_fun4 = c("0" = "white", "1" = "#CE1256")
...
OLA.trans$Feature = gsub('month-', 'mo', OLA.trans$Feature)
OLA.trans$Feature = gsub('survival', '', OLA.trans$Feature)
...
OLA.trans.table = OLA.trans.table[order(OLA.trans.table$FDR),]
...
write.csv(OLA.trans.table.out, "~/documents/Segundo_Melanoma/Results/Figures/Figure5-S5/OLA_HM_transcriptomics.csv", row.names = TRUE)
...
OLA.phospho$Feature = gsub('month-', 'mo', OLA.phospho$Feature)
OLA.phospho$Feature = gsub('survival', '', OLA.phospho$Feature)
...
write.csv(OLA.phospho.table.out, "~/documents/Segundo_Melanoma/Results/Figures/Figure5-S5/OLA_HM_phospho.csv", row.names = TRUE)
